      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 mt-2 text-white/50">
            <Link href="https://www.instagram.com/tigerstyle786" className="p-2 rounded-full glass-panel-lux hover:text-[#FF4D8D] hover:border-[#FF4D8D]/40 transition-all" aria-label="Instagram">
